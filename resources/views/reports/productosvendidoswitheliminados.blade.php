    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header ">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">Listado de Productos Vendidos (Solo productos, con eliminados)</h4>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <form id="formfilter" action="{{ route('reportes.pdfProductosVendidos') }}" method="post" target="_blank">
                            @csrf
...
<script>
    ...
    const table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('reportes.datatableProductosVendidos') }}",
            data: function(d) {
